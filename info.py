...
PICS = (environ.get('PICS', ' https://i.postimg.cc/RFktQ8Xx/5894565417026959658-121.jpg')).split()
...
QR_CODE_IMG = environ.get('QR_CODE_IMG',' https://i.postimg.cc/SK8YQVmZ/5998208024466011054-120.jpg') #add url link of your qr code to recieve money - use telegraph bot or other source to get image
UPI_ID = environ.get('UPI_ID', '@darkworld008') #enter your upi id here - grab it from your online payment methods.
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Uniform Movies™](https://t.me/UniformHelp)</b>⚡\n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>{file_size}\n\n❤")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Darkworld008) # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','Move_Download) # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','UniformHelp) # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','Darkworld008)  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "Move_Download") #[ without @ ]

# Url Shortner
URL_MODE = is_enabled((environ.get("URL_MODE","True")), False) # make it true to enable url shortner in groups or pm
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'linkcents.com') #Always use website url from api section 
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'e78e5f774a9dede8f6b3d155a1fea041a35bb720 ')
...
DISCUSSION_CHAT_USRNM = "UniformHelp" #without @

# Download Tutorial Button #
DOWNLOAD_TEXT_NAME = "📥 HOW TO DOWNLOAD 📥"
DOWNLOAD_TEXT_URL = "https://t.me/UniformHelp"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/UniformHelp"
